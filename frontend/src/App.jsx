...
const personas = {
  suresh: {
    ...
    welcome: { kn: 'ಸ್ವಾಗತ ಸುರೇಶ್! ಸ್ಕೋರ್ 742 — ತುಂಬಾ ಒಳ್ಳೆಯದು. ನೀವು ಟಾಪ್ 15% ನಲ್ಲಿದ್ದೀರಿ!', hi: 'स्वागत है सुरेश! स्कोर 742 — बहुत अच्छा। आप शीर्ष 15% में हैं!', ta: 'வரவேற்கிறோம் சுரேஷ்! ஸ்கோர் 742 — மிகவும் நல்லது.', te: 'స్వాగతం సురేష్! స్కోరు 742 — చాలా మంచిది. మీరు టాప్ 15%లో ఉన్నారు!', en: 'Welcome Suresh! Score 742 — Very Good. You are in the top 15%!' },
  ...
  ravi: {
    ...
    welcome: { kn: 'ಸ್ವಾಗತ ರವಿ! ಸ್ಕೋರ್ 684. ನೀವು ಚೆನ್ನಾಗಿ ಬೆಳೆಯುತ್ತಿದ್ದೀರಿ!', hi: 'स्वागत है रवि! स्कोर 684। आप अच्छी प्रगति कर रहे हैं!', ta: 'வரவேற்கிறோம் ரவி! ஸ்கோர் 684. நீங்கள் நன்றாக முன்னேறுகிறீர்கள்!', te: 'స్వాగతం రవి! స్కోరు 684. మీరు బాగా అభివృద్ధి చెందుతున్నారు!', en: 'Welcome Ravi! Score 684. You are improving steadily!' },
  ...
  meena: {
    ...
    welcome: { kn: 'ಸ್ವಾಗತ ಮೀನಾ! ಸ್ಕೋರ್ 521. ಆದಾಯ ಸ್ಥಿರಗೊಳಿಸಿದರೆ ಸ್ಕೋರ್ ಹೆಚ್ಚಾಗುತ್ತದೆ.', hi: 'स्वागत मीना! स्कोर 521। आय को स्थिर करने से स्कोर बढ़ेगा।', ta: 'வரவேற்கிறோம் மீனா! ஸ்கோர் 521. வருமானம் நிலையானால் ஸ்கோர் உயரும்.', te: 'స్వాగతం మీనా! స్కోరు 521. స్థిరమైన ఆదాయంతో స్కోరు పెరుగుతుంది.', en: 'Welcome Meena! Score 521. Stabilising income will improve your score.' },
...
const UI = {
  en: { score:'Credit Score', breakdown:'Score Breakdown', chart:'Monthly Income (₹)', tips:'AI Financial Tips', l1:'Avg Monthly Income', l2:'Transactions / Month', l3:'Top Payer', l4:'Income Variance', loan:'Loan Eligibility', journey:'Score Journey — 6 Months', ago:'6 Months Ago', today:'Today', chatTitle:'Kharcha Assistant', chatSub:'Financial advisor for gig workers', placeholder:'Ask about your score, loans, tips...', download:'📄 Download Report', whatsapp:'Share on WhatsApp', lender:'Lender Portal ↗', why:'Why this score? →', source:'📊 Source: UPI transaction history · No salary slip needed', signInTitle:'Welcome back', signInSub:'Sign in to view your Gig Credit Score', mobileLabel:'Mobile Number', mobilePlaceholder:'Enter your 10-digit number', pinLabel:'PIN / Password', pinPlaceholder:'Enter your 4-digit PIN', signInBtn:'Sign In Securely', signInFooter:'New here?', signInCreate:'Create account →', signInError:'Invalid demo login. Try 7777777777, 8888888888, or 9999999999.', loggedInAs:'Logged in as', signOut:'🚪 Sign Out', statAvg:'6-Mo Avg', statBest:'Best Month', statVsLast:'vs Last Mo', statTrend:'6-Mo Trend', growing:'Growing', falling:'Falling' },
  kn: { score:'ಕ್ರೆಡಿಟ್ ಸ್ಕೋರ್', breakdown:'ಸ್ಕೋರ್ ವಿಶ್ಲೇಷಣೆ', chart:'ಮಾಸಿಕ ಆದಾಯ (₹)', tips:'AI ಆರ್ಥಿಕ ಸಲಹೆ', l1:'ಸರಾಸರಿ ಮಾಸಿಕ ಆದಾಯ', l2:'ವ್ಯವಹಾರ / ತಿಂಗಳು', l3:'ಮುಖ್ಯ ಪಾವತಿದಾರ', l4:'ಆದಾಯ ವ್ಯತ್ಯಾಸ', loan:'ಸಾಲ ಅರ್ಹತೆ', journey:'ಸ್ಕೋರ್ ಪ್ರಯಾಣ — 6 ತಿಂಗಳು', ago:'6 ತಿಂಗಳ ಹಿಂದೆ', today:'ಇಂದು', chatTitle:'Kharcha ಸಹಾಯಕ', chatSub:'ಗಿಗ್ ಕಾರ್ಮಿಕರಿಗೆ ಆರ್ಥಿಕ ಸಲಹೆಗಾರ', placeholder:'ನಿಮ್ಮ ಸ್ಕೋರ್, ಸಾಲ, ಸಲಹೆ ಕೇಳಿ...', download:'📄 ವರದಿ ಡೌನ್‌ಲೋಡ್', whatsapp:'WhatsApp ನಲ್ಲಿ ಹಂಚಿ', lender:'ಸಾಲದಾತ ಪೋರ್ಟಲ್ ↗', why:'ಯಾಕೆ ಈ ಸ್ಕೋರ್? →', source:'📊 ಮೂಲ: UPI ವ್ಯವಹಾರ ಇತಿಹಾಸ · ಸಂಬಳ ಚೀಟಿ ಬೇಡ', signInTitle:'ಮರಳಿ ಸ್ವಾಗತ', signInSub:'ನಿಮ್ಮ ಗಿಗ್ ಕ್ರೆಡಿಟ್ ಸ್ಕೋರ್ ನೋಡಲು ಸೈನ್ ಇನ್ ಮಾಡಿ', mobileLabel:'ಮೊಬೈಲ್ ಸಂಖ್ಯೆ', mobilePlaceholder:'10 ಅಂಕಿಯ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ', pinLabel:'PIN / ಪಾಸ್‌ವರ್ಡ್', pinPlaceholder:'4 ಅಂಕಿಯ PIN ನಮೂದಿಸಿ', signInBtn:'ಸುರಕ್ಷಿತವಾಗಿ ಸೈನ್ ಇನ್', signInFooter:'ಹೊಸಬರೇ?', signInCreate:'ಖಾತೆ ತೆರೆಯಿರಿ →', signInError:'ಅಮಾನ್ಯ ಡೆಮೊ ಲಾಗಿನ್. 7777777777, 8888888888, ಅಥವಾ 9999999999 ಬಳಸಿ.', loggedInAs:'ಲಾಗಿನ್ ಆಗಿದ್ದಾರೆ', signOut:'🚪 ಸೈನ್ ಔಟ್', statAvg:'6-ತಿಂ ಸರಾಸರಿ', statBest:'ಉತ್ತಮ ತಿಂಗಳು', statVsLast:'ಕಳೆದ ತಿಂ vs', statTrend:'6-ತಿಂ ಟ್ರೆಂಡ್', growing:'ಬೆಳೆಯುತ್ತಿದೆ', falling:'ಇಳಿಯುತ್ತಿದೆ' },
  hi: { score:'क्रेडिट स्कोर', breakdown:'स्कोर विश्लेषण', chart:'मासिक आय (₹)', tips:'AI वित्तीय सलाह', l1:'औसत मासिक आय', l2:'लेनदेन / माह', l3:'मुख्य भुगतानकर्ता', l4:'आय भिन्नता', loan:'ऋण पात्रता', journey:'स्कोर यात्रा — 6 महीने', ago:'6 महीने पहले', today:'आज', chatTitle:'Kharcha सहायक', chatSub:'गिग वर्कर्स के लिए वित्तीय सलाहकार', placeholder:'स्कोर, लोन, सुझाव के बारे में पूछें...', download:'📄 रिपोर्ट डाउनलोड', whatsapp:'WhatsApp पर शेयर', lender:'ऋणदाता पोर्टल ↗', why:'यह स्कोर क्यों? →', source:'📊 स्रोत: UPI लेनदेन इतिहास · वेतन पर्ची की जरूरत नहीं', signInTitle:'वापस स्वागत है', signInSub:'अपना गिग क्रेडिट स्कोर देखने के लिए साइन इन करें', mobileLabel:'मोबाइल नंबर', mobilePlaceholder:'10 अंकों का नंबर दर्ज करें', pinLabel:'PIN / पासवर्ड', pinPlaceholder:'4 अंकों का PIN दर्ज करें', signInBtn:'सुरक्षित साइन इन', signInFooter:'नए हैं?', signInCreate:'खाता बनाएं →', signInError:'अमान्य डेमो लॉगिन। 7777777777, 8888888888, या 9999999999 आज़माएं।', loggedInAs:'लॉग इन हैं', signOut:'🚪 साइन आउट', statAvg:'6-माह औसत', statBest:'बेस्ट महीना', statVsLast:'पिछले माह vs', statTrend:'6-माह ट्रेंड', growing:'बढ़ रहा है', falling:'घट रहा है' },
  ta: { score:'கிரெடிட் ஸ்கோர்', breakdown:'மதிப்பெண் பகுப்பாய்வு', chart:'மாதாந்திர வருமானம் (₹)', tips:'AI நிதி ஆலோசனை', l1:'சராசரி மாத வருமானம்', l2:'பரிவர்த்தனை / மாதம்', l3:'முக்கிய செலுத்துபவர்', l4:'வருமான மாறுபாடு', loan:'கடன் தகுதி', journey:'மதிப்பெண் பயணம் — 6 மாதங்கள்', ago:'6 மாதங்களுக்கு முன்', today:'இன்று', chatTitle:'Kharcha உதவியாளர்', chatSub:'கிக் தொழிலாளர்களுக்கு நிதி ஆலோசகர்', placeholder:'உங்கள் ஸ்கோர், கடன், ஆலோசனை கேளுங்கள்...', download:'📄 அறிக்கை பதிவிறக்கம்', whatsapp:'WhatsApp இல் பகிர்', lender:'கடன் வழங்குநர் போர்டல் ↗', why:'இந்த ஸ்கோர் ஏன்? →', source:'📊 மூலம்: UPI பரிவர்த்தனை வரலாறு · சம்பள சீட்டு தேவையில்லை', signInTitle:'மீண்டும் வரவேற்கிறோம்', signInSub:'உங்கள் கிக் கிரெடிட் ஸ்கோரைப் பார்க்க உள்நுழையுங்கள்', mobileLabel:'மொபைல் எண்', mobilePlaceholder:'10 இலக்க எண்ணை உள்ளிடவும்', pinLabel:'PIN / கடவுச்சொல்', pinPlaceholder:'4 இலக்க PIN உள்ளிடவும்', signInBtn:'பாதுகாப்பாக உள்நுழை', signInFooter:'புதியவரா?', signInCreate:'கணக்கு உருவாக்கு →', signInError:'தவறான டெமோ உள்நுழைவு. 7777777777, 8888888888, அல்லது 9999999999 முயற்சிக்கவும்.', loggedInAs:'உள்நுழைந்துள்ளவர்', signOut:'🚪 வெளியேறு', statAvg:'6-மா சராசரி', statBest:'சிறந்த மாதம்', statVsLast:'கடந்த மா vs', statTrend:'6-மா போக்கு', growing:'வளர்கிறது', falling:'குறைகிறது' },
  te: { score:'క్రెడిట్ స్కోరు', breakdown:'స్కోరు విశ్లేషణ', chart:'నెలవారీ ఆదాయం (₹)', tips:'AI ఆర్థిక సలహాలు', l1:'సగటు నెలవారీ ఆదాయం', l2:'లావాదేవీలు / నెల', l3:'ముఖ్య చెల్లింపుదారు', l4:'ఆదాయ వ్యత్యాసం', loan:'రుణ అర్హత', journey:'స్కోరు ప్రయాణం — 6 నెలలు', ago:'6 నెలల క్రితం', today:'ఈరోజు', chatTitle:'Kharcha సహాయకుడు', chatSub:'గిగ్ కార్మికులకు ఆర్థిక సలహాదారు', placeholder:'మీ స్కోరు, రుణం, చిట్కాలు అడగండి...', download:'📄 నివేదిక డౌన్‌లోడ్', whatsapp:'WhatsApp లో పంచుకోండి', lender:'రుణదాత పోర్టల్ ↗', why:'ఈ స్కోరు ఎందుకు? →', source:'📊 మూలం: UPI లావాదేవీ చరిత్ర · జీతం స్లిప్ అవసరం లేదు', signInTitle:'తిరిగి స్వాగతం', signInSub:'మీ గిగ్ క్రెడిట్ స్కోరు చూడటానికి సైన్ ఇన్ చేయండి', mobileLabel:'మొబైల్ నంబర్', mobilePlaceholder:'10 అంకెల నంబర్ నమోదు చేయండి', pinLabel:'PIN / పాస్‌వర్డ్', pinPlaceholder:'4 అంకెల PIN నమోదు చేయండి', signInBtn:'సురక్షితంగా సైన్ ఇన్', signInFooter:'కొత్తవారా?', signInCreate:'ఖాతా తెరవండి →', signInError:'తప్పు డెమో లాగిన్. 7777777777, 8888888888, లేదా 9999999999 వాడండి.', loggedInAs:'లాగిన్ అయ్యారు', signOut:'🚪 సైన్ అవుట్', statAvg:'6-నె సగటు', statBest:'అత్యుత్తమ నెల', statVsLast:'గత నె vs', statTrend:'6-నె ధోరణి', growing:'పెరుగుతోంది', falling:'తగ్గుతోంది' },
}
...
export default function App() {
  ...
  const [loggedInPersona, setLoggedInPersona] = useState(null)
  ...
  // Chart stats computed live from each persona's real bar data
  const chartStats = useMemo(() => {
    const bars    = p.bars
    const avg     = Math.round(bars.reduce((a, b) => a + b, 0) / bars.length)
    const best    = Math.max(...bars)
    const bestMonth = p.barMonths[bars.indexOf(best)]
    const latest  = bars[bars.length - 1]
    const prev    = bars[bars.length - 2]
    const diff    = latest - prev
    const growing = bars[bars.length - 1] > bars[0]
    return { avg, best, bestMonth, diff, growing }
  }, [p])

  const barData = useMemo(() => {
    const max = Math.max(...p.bars)
    return p.bars.map((value, i) => ({
      value, label: p.barMonths[i],
  ...
  useEffect(() => {
    ...
    const t1 = setTimeout(() => setHeroFading(true), 3500)
    const t2 = setTimeout(() => { setHeroFading(false); setScreen('signin') }, 4100)
  ...
  // Reset chat on persona/language change
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const step = now => {
      ...
      setDisplayScore(Math.round(p.score * (1 - Math.pow(1 - t, 4))))
  ...
  useEffect(() => {
    if (screen !== 'dashboard') return
    setFactorsReady(false); setBarsReady(false)
  ...
  const handleSend = async () => {
    ...
    try {
      const reply = await askClaude(`${CHAT_PROMPTS[lang] || CHAT_PROMPTS.en} Worker context: ${p.context}`, msg)
  ...
  const handleWhyScore = async () => {
    ...
    setWhyLoading(true)
    setChatLog(prev => [...prev, { role: 'user', text: L.why.replace(' →', '') }, { role: 'bot', text: '...', loading: true }])
    try {
      const reply = await askClaude(
        `Explain a gig worker's credit score simply and warmly. No jargon. Max 3 sentences. Reply ONLY in ${langName}.`,
        `Name: ${p.name}. Score: ${p.score}/850. Factors: Income Consistency ${p.factors[0].value}% (30%), Earning Trend ${p.factors[1].value}% (25%), Transaction Volume ${p.factors[2].value}% (25%), Expense Control ${p.factors[3].value}% (20%). Explain simply.`
      )
      setChatLog(prev => prev.map((m, i) => i === prev.length - 1 ? { role: 'bot', text: reply } : m))
    } catch {
      setChatLog(prev => prev.map((m, i) => i === prev.length - 1 ? { role: 'bot', text: 'Network error.', error: true } : m))
    }
    setWhyLoading(false)
  }
  ...
  const handleSignIn = () => {
    ...
    if (!mapped) { setLoginError(L.signInError); return }
    setLoginError('')
    setIsSigningIn(true)
    setTimeout(() => {
  ...
  // ── FIX: Sign Out — resets ALL state and returns to signin ─
  const handleSignOut = () => {
  ...
  const handleVoice = () => {
    ...
    voiceRef.current = rec; rec.start(); setListening(true)
  }
  ...
  return (
    <div>
      ...
      <div className={`screen ${screen === 'hero' ? 'active' : ''} ${heroFading ? 'fade-out' : ''}`} id="screen-hero">
        <div style={{ position: 'fixed', inset: 0, zIndex: 0, background: 'linear-gradient(135deg,#3EECFF 0%,#1CE1FF 25%,#87DFFE 50%,#65FE1E 80%,#580AFF 100%)', backgroundSize: '400% 400%', animation: 'gradientShift 8s ease infinite' }} />
        <div className="hero-screen" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginBottom: '2rem', animation: 'heroReveal 0.6s cubic-bezier(0.22,1,0.36,1) both' }}>
            <div style={{ width: 80, height: 80, borderRadius: 24, background: 'rgba(255,255,255,0.25)', backdropFilter: 'blur(16px)', border: '1.5px solid rgba(255,255,255,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 36, fontWeight: 800, color: '#fff', margin: '0 auto 1rem', boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>K</div>
          </div>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.65, marginBottom: '2rem', maxWidth: 420, textAlign: 'center', color: 'rgba(255,255,255,0.82)', animation: 'heroReveal 0.8s 0.2s cubic-bezier(0.22,1,0.36,1) both' }}>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem', animation: 'heroReveal 0.8s 0.25s cubic-bezier(0.22,1,0.36,1) both' }}>
            {['🔒 Bank-grade security', '✅ RBI compliant', '⚡ 2-min setup'].map(b => (
              <div key={b} style={{ padding: '6px 14px', borderRadius: 99, background: 'rgba(255,255,255,0.18)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)', fontSize: 12, color: '#fff', fontWeight: 600 }}>{b}</div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem', animation: 'heroReveal 0.8s 0.3s cubic-bezier(0.22,1,0.36,1) both' }}>
            {LANGS.map(l => (
              <button key={l.value} onClick={() => setLang(l.value)} style={{ padding: '6px 16px', borderRadius: 99, border: '1.5px solid', borderColor: lang === l.value ? '#fff' : 'rgba(255,255,255,0.35)', background: lang === l.value ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', color: lang === l.value ? '#0F4C75' : '#fff', fontFamily: 'inherit', fontSize: 13, fontWeight: lang === l.value ? 700 : 500, cursor: 'pointer' }}>{l.label}</button>
            ))}
          </div>
          <div style={{ animation: 'heroReveal 0.8s 0.35s cubic-bezier(0.22,1,0.36,1) both' }}>
            <button onClick={() => { setHeroFading(false); setScreen('signin') }} style={{ padding: '15px 44px', borderRadius: 99, border: 'none', background: 'rgba(255,255,255,0.95)', color: '#0B3D6B', fontSize: 16, fontWeight: 800, fontFamily: 'inherit', cursor: 'pointer', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
              Get Started →
            </button>
            <div style={{ marginTop: 14, fontSize: 12, color: 'rgba(255,255,255,0.6)' }}>No documents needed · Free to use</div>
          </div>
        </div>
      </div>
        ...
        <div className="signin-wrap">
          <div className="signin-card">
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 6, marginBottom: '1.5rem', flexWrap: 'wrap' }}>
              {LANGS.map(l => (
                <button key={l.value} onClick={() => setLang(l.value)} style={{ padding: '5px 14px', borderRadius: 99, border: '1.5px solid', borderColor: lang === l.value ? 'var(--orange)' : 'rgba(249,115,22,0.25)', background: lang === l.value ? 'linear-gradient(135deg,#FFF7ED,#FEF3C7)' : 'rgba(255,255,255,0.7)', color: lang === l.value ? '#92400E' : 'var(--text2)', fontFamily: 'inherit', fontSize: 13, fontWeight: lang === l.value ? 700 : 400, cursor: 'pointer' }}>{l.label}</button>
              ))}
            </div>
            ...
            <div className="field-group">
              ...
              <input type="tel" value={phone} onChange={e => { setPhone(e.target.value); setLoginError('') }} placeholder={L.mobilePlaceholder} maxLength={10} onKeyDown={e => e.key === 'Enter' && handleSignIn()} />
            </div>
            <div className="field-group">
              <label>{L.pinLabel}</label>
              <input type="password" value={pin} onChange={e => setPin(e.target.value)} placeholder={L.pinPlaceholder} onKeyDown={e => e.key === 'Enter' && handleSignIn()} />
            </div>
            {loginError && (
            ...
            <div className="signin-footer">
              {L.signInFooter} <a onClick={() => setScreen('dashboard')} style={{ cursor: 'pointer' }}>{L.signInCreate}</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`screen ${screen === 'dashboard' ? 'active' : ''}`} id="screen-dashboard">
        <div className="navbar-wrap">
          <div className="nav-hero-title">
              <span className="brand-text">KHARCHA<span className="brand-dot">.</span></span>
          </div>
          <nav className="navbar">
            <div className="nav-logo">
              {loggedInPersona ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '4px 10px 4px 4px', borderRadius: 9999, background: 'rgba(255,255,255,0.86)', border: '1px solid rgba(249,115,22,0.16)', boxShadow: '0 2px 10px rgba(249,115,22,0.08)' }}>
                  <div className="logo-dot">{p.initial}</div>
                  <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--text2)', whiteSpace: 'nowrap' }}>
                    {L.loggedInAs} <strong style={{ color: 'var(--text1)' }}>{p.name}</strong>
                  </span>
                  <button
                    onClick={handleSignOut}
                    style={{ background: '#FEF2F2', border: '1px solid #FECACA', color: '#DC2626', fontFamily: 'inherit', fontSize: 12, fontWeight: 700, padding: '6px 14px', borderRadius: 99, cursor: 'pointer', transition: 'all 0.18s', whiteSpace: 'nowrap' }}
                  >
                    {L.signOut}
                  </button>
                </div>
                ...
                <>
                  <div className="logo-dot">K</div>
                  <span className="nav-brand">KHARCHA<span className="brand-dot">.</span></span>
                </>
              )}
            </div>
            ...
            <div className="nav-tabs" id="nav-tabs">
              {NAV_TABS.map(tab => (
                <button key={tab.key} className={`nav-tab ${activeSection === tab.key ? 'active' : ''}`} onClick={() => handleSectionSwitch(tab.key)}>{tab.label}</button>
              ))}
            </div>
          ...
          {!loggedInPersona && (
            <div className="persona-row">
              ...
              {Object.keys(personas).map(key => (
                <button key={key} className={`persona-btn ${activePersona === key ? 'active' : ''}`} onClick={() => setActivePersona(key)}>
        ...
        <div className="dashboard">
          <div className="worker-header">
            ...
            <div className="worker-info"><h2>{p.name}</h2><p>{p.sub}</p></div>
          ...
          {/* LOAN — FIX: <a> tags with pointer-events forced */}
          <div className="loan-card" id="section-loan">
            ...
            <div className="lender-chips">
              {[
                ...
                { name: 'PaySense',  url: 'https://www.gopaysense.com' },
              ].map(({ name, url }) => (
                <a key={name} href={url} target="_blank" rel="noopener noreferrer" className="lender-chip"
                  style={{ textDecoration: 'none', cursor: 'pointer', pointerEvents: 'all', display: 'inline-block' }}>
                  {name} ↗
                </a>
              ))}
            </div>
          ...
          <div className="bottom-grid" id="section-tips">
            <div className="chart-card">
              ...
              {/* ── FIX: Smart stats per persona ── */}
              <div style={{ display: 'flex', gap: 8, margin: '10px 0 14px', flexWrap: 'wrap' }}>
                <div style={{ flex: 1, minWidth: 70, background: '#F9F5F2', borderRadius: 10, padding: '8px 10px' }}>
                  <div style={{ fontSize: 9, color: '#8C7B6B', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>{L.statAvg}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#1A1410', marginTop: 2 }}>₹{chartStats.avg.toLocaleString('en-IN')}</div>
                </div>
                <div style={{ flex: 1, minWidth: 70, background: '#F9F5F2', borderRadius: 10, padding: '8px 10px' }}>
                  <div style={{ fontSize: 9, color: '#8C7B6B', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>{L.statBest}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#1A1410', marginTop: 2 }}>₹{chartStats.best.toLocaleString('en-IN')}</div>
                  <div style={{ fontSize: 10, color: '#8C7B6B' }}>{chartStats.bestMonth}</div>
                </div>
                <div style={{ flex: 1, minWidth: 70, background: chartStats.diff >= 0 ? '#DCFCE7' : '#FEE2E2', borderRadius: 10, padding: '8px 10px' }}>
                  <div style={{ fontSize: 9, color: '#8C7B6B', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>{L.statVsLast}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: chartStats.diff >= 0 ? '#16A34A' : '#DC2626', marginTop: 2 }}>
                    {chartStats.diff >= 0 ? '↑' : '↓'} ₹{Math.abs(chartStats.diff).toLocaleString('en-IN')}
                  </div>
                </div>
                <div style={{ flex: 1, minWidth: 70, background: '#F9F5F2', borderRadius: 10, padding: '8px 10px' }}>
                  <div style={{ fontSize: 9, color: '#8C7B6B', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>{L.statTrend}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: chartStats.growing ? '#16A34A' : '#DC2626', marginTop: 2 }}>
                    {chartStats.growing ? '↑' : '↓'} {chartStats.growing ? L.growing : L.falling}
                  </div>
                </div>
              </div>
              ...
              <div className="bar-chart">
                {barData.map(bar => (
                  <div className="bar-col" key={bar.label}>
                    <div style={{ fontSize: 9, fontWeight: 700, color: bar.isLatest ? '#F97316' : '#8C7B6B', marginBottom: 3, textAlign: 'center' }}>
          ...
          <div className="chat-card" id="section-chat">
            ...
            <div className="chat-messages">
              {chatLog.map((msg, i) => (
                <div key={`${msg.text}-${i}`} className={msg.error ? 'msg-error' : msg.role === 'user' ? 'msg-user' : 'msg-bot'}>{msg.text}</div>
              ))}
              <div ref={chatEndRef} />
            </div>
            <div className="chat-input-row">
              <button className={`voice-btn ${listening ? 'listening' : ''}`} onClick={handleVoice} title="Voice input">🎤</button>
              <input className="chat-input" value={chatInput} onChange={e => setChatInput(e.target.value)} placeholder={L.placeholder} onKeyDown={e => e.key === 'Enter' && handleSend()} />
